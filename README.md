...
- **String ordered comparison**: The ordering operators (`<`, `<=`, `>`, `>=`) compare two strings lexicographically, in addition to two numbers. Standard JMESPath returns `null` for non-numeric operands. See [Ordering](docs/language.md#ordering).
